...
$releases = 'https://github.com/SafeExamBrowser/seb-win-refactoring/releases/latest'
...
function global:au_GetLatest {
	...
	$url = $tags.assets.browser_download_url | Where-Object {$_ -match ".msi$"}
    $url32 = $url | Where-Object {$_ -match "x86"}
    $url64 = $url | Where-Object {$_ -match "x64"}
